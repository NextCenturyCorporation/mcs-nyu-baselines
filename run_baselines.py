...
def main(scene_file: str):
    ...
    if scene_name.startswith(PASSIVE_SPATIO_TEMPORAL_CONTINUITY_PREFIX):
        ...
        return baseline_spatialTemporalContinuity.main(scene_data)
